...
For four consecutive scout runs it has been the only non-draft open PR
org-wide, and therefore the scout's default "cheapest real contribution
available today" pick [cite:2026-08-24][cite:2026-08-25][cite:2026-08-26]
[cite:2026-08-27]. It has never been taken.
...
should be closed or declined rather than nudged again [cite:2026-08-27]. That
is a retro decision, not a scout one.
